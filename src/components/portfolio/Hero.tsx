      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              href="#"
              className="group inline-flex items-center gap-2 rounded-full border border-white/10 px-6 py-3 text-sm font-medium text-muted-foreground transition-all hover:border-white/30 hover:text-foreground"
            >
